...
Page({
  ...
  data: {
    ...
    loveBloglist: [],   // 我喜欢的博客
    blogShareImg: [
      "https://hbimg.huabanimg.com/0f2e924f9f24b483a6d31ee780208a20306f2a3a11750-rFPrzG_fw658",
  ...
  toPublish: function () {
    ...
    wx.navigateTo({
      url: `../blog-edit/blog-edit?userName=${userInfo.nickName}&avatarUrl=${userInfo.avatarUrl}`,
    })
  },
